<x-layout.admin>
    <div id="main-content" class="h-full overflow-y-auto bg-gray-50 relative lg:ml-64 pt-16">
        <main>
            <div class="flex px-4 pt-2 justify-between">
                <a href="{{ route('admin.peminjam.jaminan.create') }}"
                ...
                <x-admin.search-form action="{{ route('admin.peminjam.jaminan') }}" />
            </div>
            <x-admin.alert />
                ...
                <div class=" rounded-2xl">
                    <div class="inline-block min-w-full align-middle">
                        <div class="overflow-hidden shadow-lg">
                                    ...
                                    @foreach ($jaminan as $item)
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                                <a href="{{ route('admin.peminjam.jaminan.edit', $item->id_jaminan) }}"
                                                ...
                                                <button type="button" data-modal-toggle="delete-jaminan-modal"
                                                    onclick="deleteForm({{ $item->id_jaminan }})"
                            ...
                            <x-admin.no-data :hasData="$jaminan->count() != 0" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="relative bg-white rounded-2xl shadow-lg">
                        ...
                        <div class="flex justify-end p-2">
                            <button type="button"
                                ...
                                data-modal-toggle="delete-jaminan-modal">
                        ...
                        <div class="p-6 pt-0 text-center">
                            ...
                            <div class="flex justify-center">
                                <form action="" method="post" id="delete-jaminan-form">
                                    @csrf
                                    @method('delete')
                                    <button type="submit"
    ...
    <script>
        function deleteForm(id) {
            document.getElementById('delete-jaminan-form').action = '/admin/peminjaman/jaminan/delete/' + id;
        }
    </script>
</x-layout.admin>
