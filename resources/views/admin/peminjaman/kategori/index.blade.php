<x-layout.admin>
    <div id="main-content" class="h-full overflow-y-auto bg-gray-50 relative lg:ml-64 pt-16">
        <main>
            ...
            <div class="flex px-4 pt-2 justify-between">
                <a href="{{ route('admin.peminjam.kategori.create') }}"
                ...
                <x-admin.search-form action="{{ route('admin.peminjam.kategori') }}" />
            </div>
            <x-admin.alert />
                                    ...
                                    @foreach ($kategori as $item)
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                                <a href="{{ route('admin.peminjam.kategori.edit', $item->id) }}"
                                                ...
                                                <button type="button" data-modal-toggle="delete-kategori-modal"
    ...
    <script>
        function deleteForm(id) {
            document.getElementById('delete-kategori-form').action = '/admin/peminjaman/kategori/delete/' + id;
        }
    </script>
</x-layout.admin>
