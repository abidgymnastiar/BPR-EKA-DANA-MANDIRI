<x-layout.admin>
    <div id="main-content" class="h-full overflow-y-auto bg-gray-50 relative lg:ml-64 pt-16" style="min-height: 100vh;">
        <main>
            <div class="flex px-4 pt-2 justify-between">
                <x-admin.filter-form :filter="$filter" />
                <x-admin.search-form action="{{ route('admin.peminjam') }}" />
            </div>
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            ...
                                            <td class="p-4 space-x-2 whitespace-nowrap lg:p-5">
                                                ...
                                                <button type="button" data-modal-toggle="edit-status-modal"
                                                    onclick="formSetStatus({{ $item->id_peminjaman }},'{{ $item->status }}')"
                                                    class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 hover:text-gray-900 hover:scale-[1.02] transition-all">
                                                    <svg class="mr-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
            ...
            <!-- Edit Modal -->
            <form action="{{ route('admin.peminjam.update-status') }}" id="form-edit-peminjam" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <form action="#" id="form-detail-peminjam">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" id="pekerjaan" readonly
                                            class="shadow-lg-sm border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5"
                                            placeholder="123456" required>
                                    </div>
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="jaminan"
                                            class="block mb-2 text-sm font-medium text-gray-900">Jaminan</label>
                                        <input type="text" name="jaminan" id="jaminan" readonly
                                            class="shadow-lg-sm border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5"
                                            required>
                                    </div>
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="sertifikat_atas_nama"
                                            class="block mb-2 text-sm font-medium text-gray-900">Sertifikat atas
                                            nama</label>
                                        <input type="text" name="sertifikat_atas_nama" id="sertifikat_atas_nama"
                                            readonly
                                            class="shadow-lg-sm border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5"
                                            required>
                                    </div>
    ...
    <script>
        ...
        function showDetail(e) {
            ...
            form.pekerjaan.value = e.pekerjaan
            form.jaminan.value = e.jenis_jaminan.nama_jaminan
            form.sertifikat_atas_nama.value = e.sertifikat_atas_nama
